...
__DEFINE__(1581767632640, function(require, module, exports) {
...
}, function(modId) {var map = {"./lib/commoner":1581767632641}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1581767632641, function(require, module, exports) {
...
}, function(modId) { var map = {"./cache":1581767632642,"./watcher":1581767632644,"./context":1581767632646,"./reader":1581767632650,"./output":1581767632654,"../package.json":1581767632657}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1581767632642, function(require, module, exports) {
var assert = require("assert");
var Q = require("q");
var fs = require("fs");
var path = require("path");
...
__DEFINE__(1581767632644, function(require, module, exports) {
var assert = require("assert");
var path = require("path");
...
}, function(modId) { var map = {"./cache":1581767632642}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1581767632646, function(require, module, exports) {
var assert = require("assert");
var path = require("path");
var Q = require("q");
var util = require("./util");
...
}, function(modId) { var map = {"./cache":1581767632642,"./grep":1581767632648}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1581767632648, function(require, module, exports) {
var assert = require("assert");
var path = require("path");
var Q = require("q");
var fs = require("graceful-fs");
...
__DEFINE__(1581767632650, function(require, module, exports) {
var assert = require("assert");
var path = require("path");
var fs = require("fs");
var Q = require("q");
...
}, function(modId) { var map = {"./context":1581767632646,"./relative":1581767632652}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1581767632652, function(require, module, exports) {
var assert = require("assert");
var Q = require("q");
var path = require("path");
var util = require("./util");
...
}, function(modId) { var map = {"./reader":1581767632650}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1581767632654, function(require, module, exports) {
var assert = require("assert");
var util = require("./util");
var log = util.log;
...
__DEFINE__(1581767632657, function(require, module, exports) {
module.exports = {
  ...
  "_resolved": "https://registry.npm.taobao.org/commoner/download/commoner-0.10.8.tgz",
...
return __REQUIRE__(1581767632640);
})()
